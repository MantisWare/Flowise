...
const swaggerUiOptions = {
    ...
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description:
                'This module serves auto-generated swagger-ui generated API docs from Flowise Runner headless API service, based on a swagger.yml file. Swagger is available on: http://localhost:{PORT}/api-docs',
            license: {
                name: 'Apache 2.0',
        ...
        servers: [
            {
                url: `http://localhost:${process.env.FLOWISE_RUNNER_PORT || '3001'}/api/v1`,
                description: 'Flowise Runner API Server'
            }
        ]
    },
    apis: [`${process.cwd()}/dist/routes/**/*.js`, `${process.cwd()}/src/api-documentation/yml/swagger.yml`]
}
